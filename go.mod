...
require (
	...
	github.com/zalando/skipper v0.26.22
...
require (
	...
	github.com/valkey-io/valkey-go/valkeyhook v1.0.75 // indirect
	github.com/valkey-io/valkey-go/valkeyotel v1.0.75 // indirect
