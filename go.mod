...
require (
	...
	github.com/zalando/skipper v0.24.35
...
require (
	...
	github.com/valkey-io/valkey-go/valkeyhook v1.0.72 // indirect
	github.com/valkey-io/valkey-go/valkeyotel v1.0.72 // indirect
